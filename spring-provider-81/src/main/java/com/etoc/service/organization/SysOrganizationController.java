package com.etoc.service.organization;
...
import com.etoc.service.organization.impl.OrganizationFacade;
import com.etoc.service.organization.vo.Organization;
import com.etoc.service.organization.vo.SysOrganizationResource;
...
public class SysOrganizationController
{
    ...
    /**
     * 1.分页查询机构信息     dataType为page时
     * 2.全查询机构信息   dataType为list时
     * 3.树形查询查询机构信息 dataType为tree
     * 4.根据id查询子机构信息         id不为空时 dataType为list时
     * 5.查询最大的code值           sort为-code时 dataType为list时
     * @param pageNum 当前页码
     * @param pageSize 每页大小
        ...
        @RequestBody Organization organization)
    {
        ...
        try
        {
            OrganizationService organizationService =
                context.getBean(OrganizationFacade.class).setObject(organization).addQueryId(id);
    ...
    public ResponseEntity<?> batchOrganizationStatus(@RequestBody List<StateInstance> status)
    {
        ...
        try
        {
            //List<StateInstance> states = JSONArray.parseArray(jsons, StateInstance.class);
            OrganizationService organizationService = context.getBean(OrganizationFacade.class);
