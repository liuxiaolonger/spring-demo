...
import com.etoc.service.roleRes.RoleResourceService;
...
public class RoleResourceFacade extends AbsRoleResourceService implements RoleResourceService {
	...
	@Override
	public SysQueryListService<RoleResource> queryRoleResource() throws Exception {
		QueryListRoleResource queryListRoleResource = context.getBean(QueryListRoleResource.class).addIsLeaf(isLeaf);
	...
	public BaseService saveRoleResource() throws Exception {
		// 保存关联表的bean
	...
	@Override
	@Transactional(rollbackFor = Exception.class)
	public BaseService moveRoleResource() throws Exception {
		// 实例化修改对象
	...
	@Override
	@Transactional(rollbackFor = Exception.class)
	public BaseService removeRoleResource() throws Exception {
		RemoveListRoleResource removeListRoleResource = context.getBean(RemoveListRoleResource.class);
		if (ROLE_ID.equals(type)) {
			removeListRoleResource.addRoleId(id);
		} else if (RESOURCE_ID.equals(type)) {
