...
public class TokenUtil {
    ...
    // 过期时间 24 小时
    private  long expiration = 60 * 24 * 60 * 1000;
    // 密钥
    private String secret = "SHIRO+JWT";
...
//        claims.put(CLAIM_KEY_AUDIENCE, generateAudience(device));
    ...
    {
        String token="eyJhbGciOiJIUzUxMiJ9.eyJzdWIiOiJ0ZXN0MTIzIiwiY3JlYXRlZCI6MTU1NjQ1MTA0NjQ4NywiZXhwIjoxNTU3MzE1MDQ2fQ.hKEhhMRRz8TIOP_Vs4U8NY3IKAPwkSWoLwiVqni5tryP7WhIwhacTcmoYNKVE4a0sXz_oErjbFzO8UFn7qrcCw";
        TokenUtil util=new TokenUtil();
        String loginName=util.getClaimsFromToken(token).getSubject();
    }
}
